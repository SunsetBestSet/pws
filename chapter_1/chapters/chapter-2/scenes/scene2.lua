...
function Scene2_2:manageCollisions(thisName, otherName, cols, i, GAME)
	...
	if GAME.level == "maps/kanaroom.lua" then
		...
		elseif thisName == "ent_player" and otherName == "ent_hallwaydoor2" and GAME.player.facing == "S" then
			...
			-- can't leave room till interaction with Kana
...
local kana_avatar = love.graphics.newImage("assets/kana.png")
		Talkies.say("Leiko", "Whatever...-- the reason why I came here is because I think the legend of the disk might be true. --And someone might have found it.", {image=player_avatar})
		Talkies.say("Kana", "Cough Cough Cough ", {image=kana_avatar})
		Talkies.say("Maid", "Your Highness! Please be careful!")
		Talkies.say("Kana", "Just what are you o-on about?", {image=kana_avatar})
		Talkies.say("Kana", "Even if it might be true, the disk was said to be sealed away c-centuries ago.", {image=kana_avatar})
		Talkies.say("Leiko", "The kid has seen it, Kana. The disk. Think about it, the clouds- ", {image=player_avatar})
		Talkies.say("Leiko", "Cough Cough Cough ", {image=kana_avatar})
		Talkies.say("Leiko", "What is going on with you? I've never seen you this sick... ", {image=player_avatar})
		Talkies.say("Maid", "Your Highness...")
		Talkies.say("Kana", "Don't... worry Leiko... --I'm just facing some complications as of late...", {image=kana_avatar})
		Talkies.say("Leiko", "Sounds more than that...", {image=player_avatar})
		Talkies.say("Leiko", "* Kana has always had problems with her health but it has definitely gotten worse the last few weeks... --maybe...? *", {image=player_avatar})
		Talkies.say("Kana", "I am sorry sister, but I will have to ask a favor of you...", {image=kana_avatar})
		Talkies.say("Leiko", "What?", {image=player_avatar})
		Talkies.say("Kana", "The royal physician... will have to pay me a visit once again. --Get him for me... will you? I promise we will finish our talk after.", {image=kana_avatar})
		Talkies.say("Kana", "I promise we will finish our talk after.", {image=kana_avatar})
		Talkies.say("Kana", "Ugh... You better keep your word.", {image=player_avatar})
		Talkies.say("Kana", "Thank you, sister.", {image=kana_avatar})
end
...
function spy()
	...
	local kana_avatar = love.graphics.newImage("assets/kana.png")
		...
		Talkies.say("Leiko", "Ugh... I bet you even told her to spy on me or something.", {image=player_avatar})
		Talkies.say("Kana", "What? --How could you accuse me of such?", {image=kana_avatar})
		Talkies.say("Kana", "I'm not that wary of you. She told the queen on her own account.", {image=kana_avatar})
		Talkies.say("Leiko", "Sure...", {image=player_avatar})
...
function sorry()
	...
	local kana_avatar = love.graphics.newImage("assets/kana.png")
		...
		Talkies.say("Leiko", "I know, I'm sorry. I'll try not to...", {image=player_avatar})
		Talkies.say("Kana", "I'm glad you have realised your mistake. I am simply taking care of you, Leiko.", {image=kana_avatar})
		Talkies.say("Leiko", "...I'll try not to with you around that is...", {image=player_avatar})
		Talkies.say("Kana", "... What?", {image=kana_avatar})
		Scene2_2:moreMessages()
end
function fault()
	local	player_avatar = love.graphics.newImage("assets/leiko.png")
	local kana_avatar = love.graphics.newImage("assets/kana.png")
		...
		Talkies.say("Leiko", "Well, with you around I can't do anything, so it's your fault, although indirectly. ", {image=player_avatar})
		Talkies.say("Kana", "What?", {image=kana_avatar})
		Talkies.say("Leiko", "Mother favors you. Of course I can't get around anything.", {image=player_avatar})
		Talkies.say("Kana", "That is not true, Leiko...", {image=kana_avatar})
		Scene2_2:moreMessages()
end
